...
export const getOrder = (orderId) => {
	const request = firebaseService.firestore.collection('orders').doc(orderId).get();
...
export const updateOrder = (orderId, data) => {
	const docRef = firebaseService.firestore.collection('orders').doc(orderId).update(data);
